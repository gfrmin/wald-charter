...
3. **False consequence.** A World on which one of C1–C11 fails although §2 and S1–S5 are obeyed.
...
The newest text is the episode loop's order of steps, the Prior noun, S2's last sentence, S5, C9(b), C10, C11, E2, E3's definition of regret, and E5. Attack those first.
