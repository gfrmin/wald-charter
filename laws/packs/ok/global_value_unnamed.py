# QUESTIONS.md Q11: the space holds a reliability 1/2 that P(Global) does not name; it is no state, and the World is appendix A's.
# exercises: V2.3, V2.4
world("appendix-a", closed=True)
horizon(1, source="elicited")
depth(1, source="elicited")
space({"answer": ["a1", "a2"], "rel": ["9/10", "3/5", "1/2"]})
globals(["rel"])
