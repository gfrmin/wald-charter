# expect: PRICE
# rule: V2.5
# QUESTIONS.md Q10c: the After-act's price is a price, and Price : O and the After-act -> Q>=0 (CHARTER v0 section 1, CHARTER v0.2 section 3).
...
price({"ask": 0, "grade": -1}, source="elicited")
