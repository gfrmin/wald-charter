...
act("test", once=True, kernel=mixture([(9/10, table({"sick": {"+": 9/10, "-": 1/10}, "well": {"+": 1/5, "-": 4/5}}, source="data")), (1/5, table({"sick": {"+": 9/10, "-": 1/10}, "well": {"+": 1/5, "-": 4/5}}, source="data"))], source="data"), reads=["health"])
