...
act("test", once=True, kernel=mixture([(1/2, table({"sick": {"+": 1, "-": 1/10}, "well": {"+": 3/10, "-": 4/5}}, source="data")), (1/2, table({"sick": {"+": 4/5, "-": 1/10}, "well": {"+": 1/10, "-": 4/5}}, source="data"))], source="data"), reads=["health"])
